...
# Updated for DTA Policy v2.0 accountability roles
...
# Define role types — updated with v2.0 accountability roles
RoleType = Literal['admin', 'accountable_official', 'reviewer', 'assessor', 'viewer']
...
class Permissions:
    ...
    # v2.0 permissions
    SCREEN_SCOPE = "screen_scope"         # In-scope screening
    SET_THRESHOLD = "set_threshold"       # Threshold decision
    DTA_EXPORT = "dta_export"             # DTA register export
    DTA_NOTIFY = "dta_notify"             # DTA high-risk notification
    MANAGE_ACCOUNTABILITY = "manage_accountability"  # Assign accountability roles
...
# Role definitions with associated permissions — updated for v2.0
ROLE_PERMISSIONS = {
    'admin': [
        ...
        Permissions.SCREEN_SCOPE, Permissions.SET_THRESHOLD,
        Permissions.DTA_EXPORT, Permissions.DTA_NOTIFY,
        Permissions.MANAGE_ACCOUNTABILITY,
    ],
    'accountable_official': [
        Permissions.VIEW_DASHBOARD, Permissions.VIEW_REGISTER,
        Permissions.VIEW_AIA, Permissions.EDIT_AIA,
        Permissions.CHANGE_STATUS, Permissions.APPROVE_AIA,
        Permissions.EXPORT_AIA, Permissions.SCREEN_SCOPE,
        Permissions.SET_THRESHOLD, Permissions.DTA_EXPORT,
        Permissions.DTA_NOTIFY, Permissions.MANAGE_ACCOUNTABILITY,
    ],
    'reviewer': [
        Permissions.VIEW_DASHBOARD, Permissions.VIEW_REGISTER,
        Permissions.VIEW_AIA, Permissions.EDIT_AIA,
        Permissions.CHANGE_STATUS, Permissions.APPROVE_AIA,
        Permissions.EXPORT_AIA, Permissions.SET_THRESHOLD,
    ],
    'assessor': [
        Permissions.VIEW_DASHBOARD, Permissions.VIEW_REGISTER,
        Permissions.ADD_SYSTEM, Permissions.VIEW_AIA,
        Permissions.EDIT_AIA, Permissions.EXPORT_AIA,
        Permissions.SCREEN_SCOPE,
    ],
    'viewer': [
        Permissions.VIEW_DASHBOARD, Permissions.VIEW_REGISTER,
...
class User:
    ...
    def from_dict(cls, data: Dict) -> 'User':
        ...
        user = cls(data['email'], data['name'], data.get('role', 'viewer'), data.get('agency', ''))
